...
Los temas se guardan en un diccionario de listas con los parametros de cada tema.
...
temas['steampunk']=['Steampunk', True, True, True, u"Una variante Steampunk, orientada a la difusión de la literatura ciencia ficción del siglo XIX. Creada por Claudio Andaur."]

...
u'El software libre suele estar disponible gratuitamente,',
u'o al precio de costo;',
u'sin embargo no es obligatorio que sea así,',
u'por lo tanto no hay que asociar "libre" con "gratuito",',
u'ya que, conservando su carácter de libre,',
u'puede ser distribuido comercialmente.',
u'En inglés la palabra "free" es ambigua',
u'ya que tiene dos significados que son "libre" y "gratis"',
u'es por eso que se prefiere decir "libre" en lugar de "free",',
...
'',
u'Te cuento que la gravedad es una Fuerza de atracción',
u'que la Tierra u otro cuerpo celeste ejerce',
u'sobre los cuerpos que están cerca o sobre él.', 
u'En otras palabras la gravedad es un fenómeno natural',
u'por el cual los objetos con masa son atraídos entre sí.',
...
u'¿y que eso hace que el peso de los objetos sea diferente?,',
u'por ejemplo,',
u'el peso de los objetos en la Luna',
u'es menor que en la Tierra debido',
u'a que la gravedad en la Luna es también menor',
'',
'',
u'¡ATENCIÓN!',

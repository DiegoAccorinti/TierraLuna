...
u'piensa si se puede reutilizar,',
...
'',
u'Hoy en día aspectos muy importantes',
u'de nuestra vida cotidiana: el microondas,',
u'el lavarropas, el automóvil, el televisor,',
u'el cajero automático, la computadora doméstica',
u'y el quirófano usan software.',
u'Usamos software para educar en escuelas y universidades;',
u'el gran aparato estatal usa software.',
u'Por este motivo es tan importante comprender quién',
u'controla el software que usamos,'
u'y cómo ese control influye en nuestras vidas.',
u'El Software libre respeta la libertad de los usuarios y la comunidad,',
u'por eso tiene una visión social e inclusiva.',
u'A grandes rasgos, significa que los usuarios tienen',
u'la libertad de ejecutar, copiar, distribuir,',
u'estudiar, modificar y mejorar el software.',
...
u'Espero que te hayas divertido mucho y que',
u'te lleves algunos conocimientos con vos',
u'parasiempre.',
